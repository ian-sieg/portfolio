                ...
                {props.projArr.map(proj => 
                    <Card className='card-sizing' key={proj.id}>
                        ...
                        <Card.ImgOverlay className="card-content invis"  onMouseLeave={mouseExit} >
                            <Card.Body>
                                <Card.Title className='mb-3'><b>{proj.title}</b>
                                {width <= 1300 ? 
                                    <>
                                    <Button href={proj.repo} target='_blank' rel='noreferrer' variant='dark' className="card-btns first-btn"><i className="fa-brands fa-github"/></Button>
                                    <Button href={proj.link} target='_blank' rel='noreferrer' variant='dark' className="card-btns"><i className="fa-solid fa-link"/></Button>
                                    </>
                                    :
                                    null}
                                </Card.Title>
                                ...
                                {width > 1300 ?
                                    <>
                                    <Button href={proj.repo} target='_blank' rel='noreferrer' variant='dark' className="card-btns"><i className="fa-brands fa-github"/></Button>
                                    <Button href={proj.link} target='_blank' rel='noreferrer' variant='dark' className="card-btns"><i className="fa-solid fa-link"/></Button>
                                    </>
                                    :
                                    null
